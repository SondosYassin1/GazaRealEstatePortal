...
BEGIN TRY
    -- 0. Delete test users (anything other than 1 and 1002)
    -- Also delete their properties if they have any to avoid FK constraint errors
    DELETE FROM Properties WHERE UserId NOT IN (1, 1002);
    DELETE FROM Users WHERE Id NOT IN (1, 1002);
